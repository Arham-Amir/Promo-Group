  ...
  return (
    <section className={`${props.class}
     text-indigo-950 flex flex-col items-center justify-center gap-8`}>
      <h1 className="hover-underline-animation after:bg-indigo-800 hover:text-indigo-800 sm:text-2xl xs:text-xl 2xl:text-5xl font-semibold">{props.heading}</h1>
      <p className=" lg:w-[72%] xs:w-[80%] 2xl:text-3xl text-lg text-justify">{props.description}</p>
