    ...
    <section className="bg-[#0A1128] flex flex-col">
       <section className="w-[85%] mx-auto flex flex-row xs:flex-wrap md:flex-nowrap justify-center md:gap-x-10 py-6">
        <a href="https://www.promodevelopers.com/" target='_blank' className="h-full mx-auto xs:w-1/2 md:w-1/5 px-4 xs:order-2 md:order-1">
          <LazyImage className="h-[80px] md:h-[90px] 2xl:h-[120px] p-3 w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-themeColor transition-all duration-75" src="/logos/promodev.png"/>
        </a>
        ...
        <a href="https://www.promoland.com.pk/" target='_blank' className="h-full mx-auto xs:w-1/2 md:w-1/5 px-4 xs:order-4 md:order-4">
          <LazyImage className="h-[80px] md:h-[90px] 2xl:h-[120px] p-3 w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-themeColor transition-all duration-75" src="/logos/promoagro.png"/>
        </a>
        <a href="https://www.promogarlic.com/" target='_blank' className="h-full mx-auto xs:w-1/2 md:w-1/5 px-4 xs:order-5 md:order-5">
