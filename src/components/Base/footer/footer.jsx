    ...
    <section className="bg-[#0A1128] flex flex-col">
      ...
      <section className="w-[85%] mx-auto flex flex-row xs:flex-wrap md:flex-nowrap justify-center md:gap-x-10 py-6">
        <a href="https://www.promodevelopers.com/" target='_blank' className="h-full mx-auto xs:w-1/2 md:w-1/5 px-4 xs:order-2 md:order-1">
          <LazyImage className="drop-shadow-[0_35px_35px_rgba(255,255,255,0.40)] h-[130px] w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-themeColor transition-all duration-75" src="/logos/promodevelopers.gif"/>
        </a>
        <a href="https://www.promobrick.com/" target='_blank' className="h-full mx-auto xs:w-1/2 md:w-1/5 px-4 xs:order-3 md:order-2">
          <LazyImage className="drop-shadow-[0_35px_35px_rgba(255,255,255,0.40)] h-[130px] w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-themeColor transition-all duration-75" src="/logos/promobrick.gif"/>
        </a>
        <a href="https://www.promogroup.com.pk/" target='_blank' className="h-full mx-auto xs:w-full md:w-1/5 px-4 xs:order-1 md:order-3">
          <LazyImage className="drop-shadow-[0_35px_35px_rgba(255,255,255,0.40)] h-[80px] md:h-[160px] w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-themeColor transition-all duration-75" src="/logos/promogroup.gif"/>
        </a>
        <a href="https://www.promogarlic.com/" target='_blank' className="h-full mx-auto xs:w-1/2 md:w-1/5 px-4 xs:order-4 md:order-4">
          <LazyImage className="drop-shadow-[0_35px_35px_rgba(255,255,255,0.40)] h-[130px] w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-themeColor transition-all duration-75" src="/logos/promogarlic.gif"/>
        </a>
        <a href="https://www.promoland.com.pk/" target='_blank' className="h-full mx-auto xs:w-1/2 md:w-1/5 px-4 xs:order-5 md:order-5">
          <LazyImage className="drop-shadow-[0_35px_35px_rgba(255,255,255,0.40)] h-[130px] w-full object-contain hover:-translate-y-2 md:hover:border-t-4 border-themeColor transition-all duration-75" src="/logos/promofarms.gif"/>
        </a>
      </section>
